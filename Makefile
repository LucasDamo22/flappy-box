...
flappy: raylib
ifneq (,$(flappy_config))
	@echo "==== Building flappy ($(flappy_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f flappy.make config=$(flappy_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f flappy.make clean
